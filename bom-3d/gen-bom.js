...
const parts = [
  ...
  P({ id: "E-05B", cat: "extrusion", name: "摄像头短柱", spec: "2020 · L145", qty: 2, color: "#2b2e33", dims: "145×20×20 · z=±215", material: "2020 铝型材", tol: "±1 mm", desc: "E1.3h：前滚轮固定支架外侧立柱，平台125→梁270，不穿滚轮包络", install: "生根前滚轮支架/平台，禁止装在滚轮内部或滑架上", connects: ["F-01", "E-06B"], model: { type: "extrusion", length: 0.145 }, module: "M3" }),
  ...
  P({ id: "ST-cam", cat: "print", name: "摄像头支架", spec: "PETG · 夹E-06B@270", qty: 1, color: "#c8ccd2", dims: "夹前滚轮支架梁", material: "PETG 3周长30%", tol: "抗振夹持", desc: "E1.3h：相机装在前滚轮固定支架横梁上，不在滚轮内部", install: "夹E-06B；梁生根FR-B外立柱；俯仰-12°±8°", connects: ["E-06B", "U-03", "F-04"], stl: "../stl/camera_bracket.stl", model: { type: "cam_bracket" }, module: "M7" }),
